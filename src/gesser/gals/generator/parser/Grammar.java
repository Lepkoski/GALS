...
{   
	...
	/**
	 * Cria uma nova produ��o. Se a produ��o criada j� existe na gram�tica,
	 * null � retornado.
	 * 
	 * @param lhs lado esquerdo da produ��o
	 * @param rhs lado direito da produ��o
	 * 
	 * @return produ��o gerada, ou null se esta j� existir
	 * */
    ...
    /**
     * Gera uma representa��o String dos conjuntos First e Follow
    ...
    public String ffAsHTML()
    {
		...
		result.append(
			"<TR align=center>"+
			"<TD bgcolor=black><FONT color=white><B>S�MBOLO</B></FONT></TD>"+
    ...
    /**
     * Calcula as produ��es cujo lado esquerdo � <code>symbol</code>
     * @return BitSet indicando essas produ��es
     */
    ...
    /**
     * Transforma as recurs�es � esquerda indiretas em recus�es diretas
     * @param prods produ��es para serem processadas
     * @return lista de produ�oes sem recurs�o indireta
     */
    ...
    /**
     * Reordena os s�mbolos e as produ��es
     */
    public void sort()
    {    	
    	for (int i=FIRST_NON_TERMINAL; i < FIRST_SEMANTIC_ACTION(); i++)
    ...
    /**
     * Verifica as condi��es para esta gram�tica ser LL
     */
    public boolean isLL()
    {
        return 
    ...
    /**
     * 
     * @return um BitSet contendo produ�oes n�o fatoradas
     */
    ...
    /**
     * Verifica a terceira condi��o LL
     */
    ...
    /**
     * Remove os s�mbolos inalcan��veis da gram�tica
     * @throws EmptyGrammarException se o s�mbolo inicial for removido
     */
    ...
    /**
     * Gera uma representa��o de um BitSet utilizando os s�mbolos da Gram�tica
     *
     * @param b BitSet a ser convertido
     *
     * @return representa��o do BitSet
     */
    ...
    /**
     * Executa uma deriva��o mais a esquerda na produ��o passada como parametro
     *
     * @param p produ��o a sofrer a deriva��o
     */
	...
	/**
	 * Calcula o prefixo comum de um conjunto de produ��es.
	 *
	 * @param prods conjunto de produ��es com prefixo comum.
	 * 
	 * @return prefixo comum entre as produ��es. 
	 * 
	 */
